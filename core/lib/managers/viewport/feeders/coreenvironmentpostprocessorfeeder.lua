			...
			if modifier then
				...
				if material then
					for k,v in pairs(block) do
						local value = v
						if k == "luminance_clamp" or
							k == "start_color" or
							k == "color0" or
							k == "color1" or
							k == "color2" or
							k == "environment_map_intensity" or
							k == "environment_map_intensity_shadow" or
							k == "ambient_color" or
							k == "sky_top_color" or
							k == "sky_bottom_color" or
							k == "sky_reflection_bottom_color" or
							k == "sky_reflection_top_color" or
							k == "sun_specular_color" or
							k == "fog_start_color"
						then
							value = v * LightIntensityDB:platform_intensity_scale()
						end			
						
           -- If PS3 OR XBOX360. In the end not used on Consoles
						if false then
							if k == "ambient_color" or
								k == "sky_top_color" or
								k == "sky_bottom_color" or
								k == "fog_min_range" or
								k == "fog_max_range"
