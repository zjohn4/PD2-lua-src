...
function CoreCutsceneKey:types()
	...
	table.sort(sorted_types, function(a, b) return a.NAME < b.NAME end)
	return sorted_types
end
...
function CoreCutsceneKey:colour_palette()
	if self._colour_palette == nil then
		local hex_values = { "468966", "FFF0A5", "FFB03B", "B64926", "445878", "046380", "ADCF4F", "4A1A2C", "8E3557", "CCB689", "7EBE74", "756D43",
							 "664689", "A5FFF0", "3BFFB0", "26B649", "784458", "800463", "4FADCF", "2C4A1A", "578E35", "89CCB6", "747EBE", "43756D",
							 "896646", "F0A5FF", "B03BFF", "4926B6", "587844", "638004", "CF4FAD", "1A2C4A", "35578E", "B689CC", "BE747E", "6D4375" }
		self._colour_palette = table.collect(hex_values, function(hex) return Color(hex) end)
	end
...
-- Register all cutscene key classes below the keys directory with our class.
