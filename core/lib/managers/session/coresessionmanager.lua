...
function SessionManager:init(session_factory, input_manager)
	...
	self._player_slots:add_player_slot() -- we assume that we have at least one local player 
	...
	self._state_machines = {game_state, menu_state, dialog_state, freeze_state, self._player_slots, self._local_user_manager, self._session_state}
	self._state_machines_except_menu_and_game = {   dialog_state, freeze_state, self._player_slots, self._local_user_manager, self._session_state}
