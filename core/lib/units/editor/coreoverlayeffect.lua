...
function CoreOverlayEffectHubElement:_build_panel( panel, panel_sizer )	
	...
	local effects_sizer = EWS:BoxSizer( "HORIZONTAL" )
		...
		effects:append( "none" )
		local t = {}
		-- for name,_ in pairs( tweak_data.player.overlay ) do
		...
		effects:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = effects, value = "overlay_effect" } )
	...
	local fade_in_sizer = EWS:BoxSizer( "HORIZONTAL" )
		...
		fade_in:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_option_time" ), { ctrlr = fade_in, value = "overlay_effect_fade_in" } )
		fade_in:connect( "EVT_KILL_FOCUS", callback( self, self, "set_option_time" ), { ctrlr = fade_in, value = "overlay_effect_fade_in" } )
	...
	local sustain_sizer = EWS:BoxSizer( "HORIZONTAL" )
		...
		sustain:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_option_time" ), { ctrlr = sustain, value = "overlay_effect_sustain" } )
		sustain:connect( "EVT_KILL_FOCUS", callback( self, self, "set_option_time" ), { ctrlr = sustain, value = "overlay_effect_sustain" } )
	...
	local fade_out_sizer = EWS:BoxSizer( "HORIZONTAL" )
		...
		fade_out:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_option_time" ), { ctrlr = fade_out, value = "overlay_effect_fade_out" } )
		fade_out:connect( "EVT_KILL_FOCUS", callback( self, self, "set_option_time" ), { ctrlr = fade_out, value = "overlay_effect_fade_out" } )
