...
function CoreDebugUnitElement:_build_panel( panel, panel_sizer )
	...
	as_subtitle:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = as_subtitle, value = "as_subtitle" } )
	...
	show_instigator:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = show_instigator, value = "show_instigator" } )
