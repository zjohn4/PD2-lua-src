...
function CoreUnitSequenceUnitElement:add_to_mission_package()
	managers.editor:add_to_world_package( { category = "units", name = "core/units/run_sequence_dummy/run_sequence_dummy", continent = self._unit:unit_data().continent } )
	managers.editor:add_to_world_package( { category = "script_data", name = "core/units/run_sequence_dummy/run_sequence_dummy.sequence_manager", continent = self._unit:unit_data().continent } )
end
