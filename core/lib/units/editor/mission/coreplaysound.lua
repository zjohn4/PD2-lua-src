...
function CorePlaySoundUnitElement:init( unit )	
	...
	-- table.insert( self._save_values, "sound_bank" )
...
function CorePlaySoundUnitElement:_build_panel( panel, panel_sizer )
	...
	sound_events:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = sound_events, value = "sound_event" } )
	...
	prefix:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = prefix, value = "append_prefix" } )
