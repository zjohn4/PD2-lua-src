...
function CoreCounterUnitElement:remove_unit_list_btn()
	local f = function( unit ) return self._digital_gui_units[ unit:unit_data().unit_id ] end
...
function CoreCounterFilterUnitElement:_build_panel( panel, panel_sizer )
	...
	local check_type_params = {
		...
		panel 				= panel,
		sizer 				= panel_sizer,
		options				= { "equal", "less_than", "greater_than", "less_or_equal", "greater_or_equal", "counters_equal", "counters_not_equal" },
