...
function ColorPickerDraggables:_create_panel(parent_frame, enable_alpha, enable_value)
	...
	if enable_value then
		...
		-- No need to show the value slider - resize the spectrum to take up the remaining space.
		spectrum_size = spectrum_size:with_x(spectrum_size.x + slider_width + slider_margin)
	end
	
	if enable_alpha then
		-- Create another gradient slider for the alpha.
		...
		-- No need to show the alpha slider - resize the spectrum to take up the remaining space.
		spectrum_size = spectrum_size:with_x(spectrum_size.x + slider_width + slider_margin)
	end
