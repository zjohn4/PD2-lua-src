...
-- Called from editor when a group is about to be removed
...
-- Called from editor when a group has been created
...
-- Called from editor when a group has been selected
...
-- Goes through all layers all groups and append them to the list. The group is also stored in a table which then can be accessed 
