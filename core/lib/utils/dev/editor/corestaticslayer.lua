...
-- CoreStaticsLayer.StaticsLayer is the layer called Statics in the editor. It contains and handels 
-- all static units.
...
function StaticsLayer:set_enabled( enabled ) -- Dont want to disable this layer
	if not enabled then
