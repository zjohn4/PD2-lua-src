...
function DynamicLayer:set_select_unit( unit )
	if self._selected_unit and (self._selected_unit == unit) then -- selecting the selected units picks or releases it
...
-- I want do deselect the unit when changing layer. Outerwise the physic move might be activated when global selecting a unit
