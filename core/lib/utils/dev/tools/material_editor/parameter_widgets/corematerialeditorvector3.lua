...
function CoreMaterialEditorVector3:_on_slider()
	self._value = self:_from_slider_range(Vector3(
		self._x_slider:get_value(),
		self._y_slider:get_value(),
		self._z_slider:get_value()
	))
...
function CoreMaterialEditorVector3:_on_text_ctrl()
	self._value = Vector3(
		tonumber(self._x_text_ctrl:get_value()) or 0,
		tonumber(self._y_text_ctrl:get_value()) or 0,
		tonumber(self._z_text_ctrl:get_value()) or 0
	)
...
function CoreMaterialEditorVector3:_to_slider_range(v)
	...
	return Vector3(
		CoreMaterialEditorParameter.to_slider_range(self, v.x, self._parameter_info.min.x, step_x),
		CoreMaterialEditorParameter.to_slider_range(self, v.y, self._parameter_info.min.y, step_y),
		CoreMaterialEditorParameter.to_slider_range(self, v.z, self._parameter_info.min.z, step_z)
	)
end
...
function CoreMaterialEditorVector3:_from_slider_range(v)
	...
	return Vector3(
		CoreMaterialEditorParameter.from_slider_range(self, v.x, self._parameter_info.min.x, step_x),
		CoreMaterialEditorParameter.from_slider_range(self, v.y, self._parameter_info.min.y, step_y),
		CoreMaterialEditorParameter.from_slider_range(self, v.z, self._parameter_info.min.z, step_z)
	)
end
