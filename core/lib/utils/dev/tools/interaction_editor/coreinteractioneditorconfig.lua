...
NODE_COLORS = {Color(243, 243, 243), Color(102, 255, 172),
				Color(255, 185, 102), Color(200, 100, 100),
				Color(255, 136, 102), Color(100, 200, 200),
				Color(36, 120, 166), Color(33, 166, 95)}
				
DEFAULT_NODE_COLOR = NODE_COLORS[1]

NODE_TYPES = {"undefined", "event",
				"boolean", "color",
				"number", "references",
				"string", "vector"}
