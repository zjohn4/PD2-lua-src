...
local DEFAULT     = Vector3(1.0,1.0,1.0)
local HIGHLIGHTED = Vector3(0.8,0.8,1.0)
local PERCENT, SECONDS, PLAIN = 0, 1, 2
local DEFAULT_FORMAT = PERCENT


-- =============================================================================
--  class: L u a P r o f i l e r G r i d B o x
--
-- =============================================================================
LuaProfilerGridBox = LuaProfilerGridBox or CoreClass.class()

-- -----------------------------------------------------------------------------
--  methods for init/setting of data
-- -----------------------------------------------------------------------------
...
function LuaProfilerGridBox:init( ... )
	...
	self._baseheader  = { "Func", "File", "Line", "Total time", "Local time", "Children time", "No. Calls", "No. Sub Calls" }	
	self._sortcolumn  = 1
...
-- a lightweight version of 'set_profilerdata()'
