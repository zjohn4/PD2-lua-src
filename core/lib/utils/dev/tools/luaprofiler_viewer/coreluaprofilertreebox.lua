...
-- =============================================================================
--  class: L u a P r o f i l e r T r e e B o x
--
-- =============================================================================
...
function LuaProfilerTreeBox:_makelabel( cnid )
	...
	if cnid == self._lpd:rootcallnode() then
		...
		label = label .. string.format( "%s (%s/%s)",
			                             self._lpd:fn_func(fnid),
		                                 self._lpd:fn_file(fnid),
		                                 self._lpd:fn_line(fnid) )
