...
function set_widget_help(widget, help_text) 
	-- TODO: possibly connect event handler on mouse-over, set help text in multiline textbox
...
function set_widget_box_help(widget, help_header, help_text, view)
	...
	widget:connect("EVT_LEFT_DOWN", on_left_down, {view, help_header, help_text})
end
