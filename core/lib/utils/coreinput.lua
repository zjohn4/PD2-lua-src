...
Module CoreInput - basic controller functionality. 

]]--


----------------------------------------------------------------------
-- functions: shift, ctrl, alt
--
-- Utility functions for checking if ant of these combination buttons are used.
----------------------------------------------------------------------
function shift()
...
-- class: R e p K e y
--
-- RepKey is a class to keep track on with what intervall 
-- a downed key should report that it is down. Useful when 
-- wanting to be able to keep a button down without getting 
-- a result every frame.
----------------------------------------------------------------------
