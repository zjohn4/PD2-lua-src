...
The CoreSerialize module implements support for serializing
and deserializing of Lua objects. So far it is pretty thin,
only supporting classtables. See also DEP_0068.
