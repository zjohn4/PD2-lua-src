...
-- Temporary fix (since 1/7-2009) until we get a callback whenever a unit is preload:ed or until we can retrieve which unit dependencies a certain unit have:
