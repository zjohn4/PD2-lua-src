...
C o r e E n g i n e A c c e s s
-------------------------------

The CoreEngineAccess hides certain Engine functionality so that 
only Core have access to it. The access control is not strict,
after all it is only Lua, but Gameplay must avoid accessing the
