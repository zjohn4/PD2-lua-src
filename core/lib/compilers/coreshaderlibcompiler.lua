...
CoreShaderLibCompiler.SHADER_NAME = "base" -- TODO!
...
function CoreShaderLibCompiler:up_to_date(file, dest)
	return dest:up_to_date(file.path, "render_template_database", file.name, file.properties) and
		dest:up_to_date("core\\shader_sources\\base", "shader_source", "core/shader_sources/base", {}) and
		dest:up_to_date("core\\shader_sources\\common_include", "shader_source", "core/shader_sources/common_include", {})
end
...
function CoreShaderLibCompiler:run_compiler()
	...
	for line in file:lines() do cat_print( "debug", line) end
end
