...
function NetworkMatchMakingPSN:search_lobby( settings )
	...
	-- managers.menu:show_retrieving_servers_dialog()
	PSN:search_session( table_description, filter, PSN:get_world_list()[1].world_id, self._search_lobbys_index, self.MAX_SEARCH_RESULTS, true ) -- Last parameter indicates server index
end
