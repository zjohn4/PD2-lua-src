...
function BlackMarketTweakData:_init_masks()
	...
	self.masks.cloth_commander.pcs = { 10, 20, 30, 40 }
	...
	self.masks.gage_blade.pcs = { 10, 20, 30, 40 }
	...
	self.masks.gage_rambo.pcs = { 10, 20, 30, 40 }
	...
	self.masks.gage_deltaforce.pcs = { 10, 20, 30, 40 }
...
function BlackMarketTweakData:_init_materials()
	...
	self.materials.gunmetal.pcs = { 10, 20, 30, 40 }
	...
	self.materials.mud.pcs = { 10, 20, 30, 40 }
	...
	self.materials.splinter.pcs = { 10, 20, 30, 40 }
	...
	self.materials.erdl.pcs = { 10, 20, 30, 40 }
...
function BlackMarketTweakData:_init_textures()
	...
	self.textures.styx.pcs = { 10, 20, 30, 40 }
	...
	self.textures.fingerpaint.pcs = { 10, 20, 30, 40 }
	...
	self.textures.fighter.pcs = { 10, 20, 30, 40 }
	...
	self.textures.warrior.pcs = { 10, 20, 30, 40 }
...
function BlackMarketTweakData:_init_melee_weapons()
	...
	self.melee_weapons.fists.anim_attack_vars = { "var1", "var2", "var3", "var4" }
	self.melee_weapons.fists.expire_t = 1
	self.melee_weapons.fists.repeat_expire_t = 0.55000001192093
	self.melee_weapons.fists.melee_damage_delay = 0.20000000298023
	...
	self.melee_weapons.kabar.anim_attack_vars = { "var1", "var2", "var3", "var4" }
