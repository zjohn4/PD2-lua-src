...
-- SAFEHOUSE					
	...
	self.jobs.escape_hell.chain = {
												{ level_id = "escape_hell", type_id = "heist_type_assault", type = "d" }
											}
	self.jobs.escape_hell.briefing_event = "pln_fj1_cbf_01"
	self.jobs.escape_hell.debrief_event = nil
	self.jobs.escape_hell.crimenet_callouts = { "pln_fj1_cnc_01_01", "pln_fj1_cnc_01_02", "pln_fj1_cnc_01_03" }
	self.jobs.escape_hell.crimenet_videos = { "cn_jewel1", "cn_jewel2", "cn_jewel3" }
	self.jobs.escape_hell.payout = { 37000, 43000, 60000, 70000 }
