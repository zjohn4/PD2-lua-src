...
function AssetsTweakData:_init_assets( tweak_data )
	...
	self.grenade_crate.stages = { "watchdogs_1", "watchdogs_2", "welcome_to_the_jungle_1", "welcome_to_the_jungle_2", "alex_1", "firestarter_1", "firestarter_2", "firestarter_3", "branchbank", "arm_for", "roberts" }
