...
function WeaponTweakData:_init_new_weapons( autohit_rifle_default, autohit_pistol_default, autohit_shotgun_default, autohit_lmg_default, damage_melee_default, damage_melee_effect_multiplier_default, aim_assist_rifle_default, aim_assist_pistol_default, aim_assist_shotgun_default, aim_assist_lmg_default )
	...
	self.hk21.auto = {}						-- Defines the weapons fire mode
	...
	-- kick up, down, left, right
	self.hk21.kick = {}
	self.hk21.kick.standing = { -0.2, 0.8, -0.8, 1 }
	...
	self.m249.auto = {}						-- Defines the weapons fire mode
	...
	-- kick up, down, left, right
	self.m249.kick = {}
	self.m249.kick.standing = { -0.2, 0.8, -1, 1.4 }
	...
	self.rpk.auto = {}						-- Defines the weapons fire mode
	...
	-- kick up, down, left, right
	self.rpk.kick = {}
	self.rpk.kick.standing = { -0.2, 0.8, -1, 1.4 }
