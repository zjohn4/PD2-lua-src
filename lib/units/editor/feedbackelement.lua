...
function FeedbackUnitElement:_build_panel( panel, panel_sizer )
	...
	local camera_shake_effect_params = {
		...
		options						= { "mission_triggered", "headbob", "player_land", "breathing" },
	...
	camera_shake_effect:connect( "EVT_COMMAND_COMBOBOX_SELECTED", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_effect, value = "camera_shake_effect" } )
	...
	camera_shake_frequency:connect( "EVT_COMMAND_TEXT_ENTER", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_frequency, value = "camera_shake_frequency" } )
	camera_shake_frequency:connect( "EVT_KILL_FOCUS", callback( self, self, "set_element_data" ), { ctrlr = camera_shake_frequency, value = "camera_shake_frequency" } )
