...
function AiGlobalEventUnitElement:init( unit )
	...
	self._blames = { "none", "empty", "cop", "gangster", "civilian", "metal_detector", "security_camera", "civilian_alarm", "cop_alarm", "gangster_alarm", "motion_sensor", "glass_alarm", "blackmailer", "gensec", "police_alerted", "csgo_gunfire" }
