...
function DialogueUnitElement:_build_panel( panel, panel_sizer )
	...
	execute_on_executed_when_done:connect( "EVT_COMMAND_CHECKBOX_CLICKED", callback( self, self, "set_element_data" ), { ctrlr = execute_on_executed_when_done, value = "execute_on_executed_when_done" } )
