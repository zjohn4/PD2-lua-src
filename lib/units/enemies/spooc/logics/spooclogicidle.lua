...
function SpoocLogicIdle._exit_hiding( data )
	...
	data.unit:set_objective( { type = "act", action = { type = "act", body_part = 1, variant = "idle", blocks = { idle = -1, turn = -1, action = -1, walk = -1, light_hurt = -1, hurt = -1, heavy_hurt = -1, expl_hurt = -1 } } } )
