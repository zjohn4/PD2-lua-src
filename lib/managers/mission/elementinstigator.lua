...
function ElementInstigatorOperator:on_executed( instigator )
	...
	if self._values.operation == "set" or self._values.operation == "add_first" or
			self._values.operation == "add_last" or self._values.operation == "clear" then
...
function ElementInstigatorOperator:_check_and_execute( use_instigator )
	...
	elseif Application:editor() then
		managers.editor:output_error( "Cant use instigator. Reason: "..( not alive( use_instigator ) and " Dont exist" or use_instigator:character_damage():dead() and "Dead" )..". In element "..self._editor_name.."." )
	end
end
