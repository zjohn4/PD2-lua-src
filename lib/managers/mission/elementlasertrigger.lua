...
ElementLaserTrigger.COLORS = { red = {1, 0, 0}, green = {0, 1, 0}, blue = {0, 0, 1} }
...
function ElementLaserTrigger:init( ... )
	...
	for i, connection in ipairs( self._values.connections ) do
		...
		table.insert( self._connections, { enabled=not self._is_cycled, from=self._values.points[ connection.from ], to=self._values.points[ connection.to ] } )
	end
