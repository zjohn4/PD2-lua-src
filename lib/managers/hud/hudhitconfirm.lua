...
function HUDHitConfirm:init( hud )
	...
	self._crit_confirm = self._hud_panel:bitmap( { valign = "center", halign = "center", visible = false, name = "crit_confirm", texture = "guis/textures/pd2/hitconfirm_crit", color = Color.white, layer = 0, blend_mode = "add" } )
